...
<input type="text" name="user_login" value="<?php echo isset($_POST['user_login']) ? $_POST['user_login'] : '' ?>" placeholder="Username"<?php echo !isset($_POST['user_login']) ? ' autofocus' : '' ?> required />
<input type="password" name="user_password" placeholder="Password"<?php echo isset($_POST['user_login']) ? ' autofocus' : '' ?> required />
<button type="submit">Login</button>
<input type="hidden" name="next" value="<?php echo isset($_GET['next']) ? urlencode($_GET['next']) : uelencode(ADMIN_URI.'index.php') ?>" />
</form>
</div>
</div>
</body>
