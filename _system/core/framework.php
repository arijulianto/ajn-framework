...
if(isset($_GET['ext'])) $ext = trim($_GET['ext'],'.');
 ...
 *---------------------------------------------------------------
*/
if(isset($config['site_login']) && !($_SESSION['admin_uid'] || $_SESSION['user_uid'])){
	define('MODULE', 'login');
}elseif(isset($_GET['module']) && $_GET['module']==ADMIN_DIR){
	if(isset($slug1)){
		define('MODULE', (isset($_SESSION['admin_uid'])?$slug1:'login'));
	}else{
...
*/
// Module Full Path
if(!defined('MODULE_DIR')) define('MODULE_DIR', MODULE_PATH . MODULE . '/');
// Module Site URI
if(!defined('MODULE_URI')) define('MODULE_URI', SITE_URI . MODULE);
// Module Site URL
if(!defined('MODULE_URL')) define('MODULE_URL', SITE_URL . MODULE);
 ...
 *---------------------------------------------------------------
*/
$limit   = isset($setting['paging']) ? $setting['paging'] : $conf['default_paging'];
...
define('SITE_NAME', isset($setting['site_name']) ? $setting['site_name'] : $conf['site_name']);
